program schrodinger_gaussian
    ...
    real(dp), parameter :: V0 = 100.0_dp     ! Height of the finite square well
    real(dp), parameter :: x_a = 1.0_dp       ! Half-width of the finite square well
